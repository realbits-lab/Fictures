...
-- Date: 2025-11-02
-- Purpose: Remove legacy field in favor of Adversity-Triumph Engine fields
...
-- - character_focus (text) - DEPRECATED legacy field, replaced by focus_characters array
