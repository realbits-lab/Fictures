...
import { stories, chapters, parts, scenes, users } from './src/lib/db/schema.js';
...
async function createCompleteContent(scenes, genre) {
  const genreContent = storyContent[genre] || storyContent.fantasy;
