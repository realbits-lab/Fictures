...
export function CommunityContentClient({ initialStories }: CommunityContentClientProps) {
  ...
  const stories = (data?.success ? data.stories : initialStories).map((story: any) => ({
    ...story,
      ...
      {error && (
        <Card className="border-red-200 dark:border-red-800 mb-8">
          <CardContent className="py-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">{error.toString()}</p>
