                              ...
                              <div className="flex gap-2 text-xs">
                                {character.personality.myers_briggs && (
                                  <span className="text-gray-600 dark:text-gray-400">
                                    MBTI: <span className="font-semibold text-gray-900 dark:text-gray-100">{character.personality.myers_briggs}</span>
                                  </span>
                                )}
                                {character.personality.enneagram && (
                                  <span className="text-gray-600 dark:text-gray-400">
                                    Enneagram: <span className="font-semibold text-gray-900 dark:text-gray-100">{character.personality.enneagram}</span>
                                  </span>
                                )}
                              </div>
                            </div>
                            ...
                            <div className="space-y-1 text-sm">
                              {character.motivations.primary && (
                                <p className="text-gray-900 dark:text-gray-100">
                                  <span className="font-semibold text-green-600 dark:text-green-400">Primary:</span> {character.motivations.primary}
                                </p>
                              )}
                              {character.motivations.secondary && (
                                <p className="text-gray-900 dark:text-gray-100">
                                  <span className="font-semibold text-blue-600 dark:text-blue-400">Secondary:</span> {character.motivations.secondary}
                                </p>
                              )}
                              {character.motivations.fear && (
                                <p className="text-gray-900 dark:text-gray-100">
                                  <span className="font-semibold text-red-600 dark:text-red-400">Fear:</span> {character.motivations.fear}
                                </p>
                              )}
                            </div>
                          </div>
                  ...
                  {isExpanded && (
                    <div className="animate-in fade-in duration-300">
                      ...
                      <div className="p-4 space-y-3 bg-white dark:bg-gray-800">
                        ...
                        {/* Color Palette */}
                        {setting.colorPalette && setting.colorPalette.length > 0 && (
                          <div>
                        ...
                        {/* Sensory Details */}
                        {setting.sensory && Object.keys(setting.sensory).length > 0 && (
                          <div>
                            <h5 className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">
                              Sensory Details
                            </h5>
                            <div className="space-y-2">
                              {Object.entries(setting.sensory).map(([sense, details]) => (
                                <div key={sense}>
