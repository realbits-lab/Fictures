        ...
        <div className="max-w-4xl mx-auto space-y-4">
          {updates.map((update, index) => (
            <Link key={`${update.storyId}-${update.chapterId}-${index}`} href={`/reading/${update.storyId}`}>
              <Card className="transition-all hover:shadow-lg hover:border-[rgb(var(--primary))] cursor-pointer group">
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-[rgb(var(--muted-foreground))] mb-2">
                        <span className="font-medium">Chapter {update.chapterNumber}:</span> {update.chapterTitle}
                      </p>
                    ...
                    <div className="flex-shrink-0">
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[rgb(var(--primary))] to-[rgb(var(--primary)/60%)] flex items-center justify-center text-2xl group-hover:scale-110 transition-transform">
                        📖
                      </div>
                    </div>
                  </div>
