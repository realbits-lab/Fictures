        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {readerFeatures.map((feature, index) => (
              <div key={index} className="text-center p-6 rounded-lg hover:bg-[rgb(var(--color-background))] hover:shadow-lg transition-all">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            {writerFeatures.map((feature, index) => (
              <div key={index} className="text-center p-6 rounded-lg bg-[rgb(var(--color-background))] border border-[rgb(var(--color-border))] hover:border-[rgb(var(--color-primary))] hover:shadow-lg transition-all">
                <div className="text-5xl mb-4">
                  {feature.icon}
                </div>
                <h3 className="text-xl font-semibold text-[rgb(var(--color-foreground))] mb-3">
