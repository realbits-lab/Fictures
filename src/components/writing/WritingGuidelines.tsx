...
export function WritingGuidelines({ currentLevel = "scene" }: WritingGuidelinesProps) {
  const [expandedSections, setExpandedSections] = useState<Set<string>>(new Set(["mru"]));
      ...
      content: (
        <div className="space-y-3 text-sm">
          ...
          <div className="text-xs text-gray-600 dark:text-gray-400">
            <strong>Example:</strong> Door slams (motivation) → John startles (reaction) → He reaches for his weapon (action)
          </div>
        </div>
      )
    },
      ...
      content: (
        <div className="space-y-3 text-sm">
          <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg border border-green-200 dark:border-green-700">
            <h4 className="font-semibold text-green-800 dark:text-green-200 mb-2">Key Elements:</h4>
            <ul className="space-y-1 text-green-700 dark:text-green-300">
              <li><strong>Goal:</strong> What character wants</li>
              <li><strong>Conflict:</strong> Opposition/obstacle</li>
              <li><strong>Disaster:</strong> Failure or complication</li>
              <li><strong>Reaction:</strong> Emotional response</li>
              <li><strong>Dilemma:</strong> Difficult choice</li>
              <li><strong>Decision:</strong> Path forward</li>
            </ul>
          </div>
        </div>
      )
      ...
      content: (
        <div className="space-y-3 text-sm">
          <div className="bg-yellow-50 dark:bg-yellow-900/20 p-3 rounded-lg border border-yellow-200 dark:border-yellow-700">
            <h4 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">Speed Techniques:</h4>
            <div className="text-yellow-700 dark:text-yellow-300 space-y-2">
              <div>
                <strong>Fast:</strong> Short sentences, dialogue, action verbs, less description
              </div>
              <div>
                <strong>Slow:</strong> Longer sentences, internal thoughts, detailed description, reflection
              </div>
            </div>
          </div>
        </div>
