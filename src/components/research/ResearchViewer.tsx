          ...
          <div className="flex items-start justify-between mb-4">
            ...
            {canDelete && (
              <button
                ...
                disabled={isDeleting}
                className="ml-4 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium"
              >
