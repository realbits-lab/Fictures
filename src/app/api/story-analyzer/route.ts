...
4. RETURN the updated story data as valid JSON
...
- Ensure the output is valid JSON that matches the StoryData interface
...
Return ONLY valid JSON of the updated story data, nothing else.`,
...
Please modify the story data according to this request and return the updated story as valid JSON.`,
    ...
    const updatedStoryData = JSON.parse(cleanedResponse);
