          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                Generate API keys to access your Fictures data programmatically
              </p>
            </div>
            <Button
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
              ...
              <div className="text-sm text-green-700 dark:text-green-300">Active Keys</div>
            </div>
            <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg">
              <div className="text-2xl font-bold text-red-900 dark:text-red-100">
                {metadata.expired}
              </div>
              <div className="text-sm text-red-700 dark:text-red-300">Expired Keys</div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 max-h-40 overflow-y-auto">
                  {availableScopes.map((scope) => (
                    <label key={scope.scope} className="flex items-center space-x-2">
                      <input
                        type="checkbox"
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                        <div>
                          <strong>Key:</strong> <code>{apiKey.keyPrefix}...</code>
                        </div>
                        <div>
          ...
          <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            ...
            <div className="text-sm text-blue-800 dark:text-blue-200 space-y-2">
              ...
              <div className="font-mono text-xs bg-white dark:bg-blue-900 p-2 rounded">
                <div>Header: <code>X-API-Key: your_api_key_here</code></div>
                <div>Or: <code>Authorization: Bearer your_api_key_here</code></div>
              </div>
              <p>
