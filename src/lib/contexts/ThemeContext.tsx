...
export const themes: Theme[] = [
  {
    id: 'light',
    name: 'Light',
    summary: 'Clean and bright default theme',
    preview: {
  ...
  },
  {
    id: 'dark',
    name: 'Dark',
    summary: 'Modern dark theme for low-light writing',
    preview: {
      primary: 'rgb(59 130 246)',
  ...
  },
  {
    id: 'ocean',
    name: 'Ocean Blue',
    summary: 'Calming blue tones inspired by the sea',
    preview: {
      primary: 'rgb(59 130 246)',
  ...
  },
  {
    id: 'purple',
    name: 'Purple Dream',
    summary: 'Creative purple theme for imaginative writing',
    preview: {
  ...
  },
  {
    id: 'forest',
    name: 'Forest Green',
    summary: 'Nature-inspired green theme for focused writing',
    preview: {
  ...
  },
  {
    id: 'sunset',
    name: 'Warm Sunset',
    summary: 'Warm orange tones for cozy writing sessions',
    preview: {
  ...
  },
  {
    id: 'rose',
    name: 'Rose Garden',
    summary: 'Elegant pink theme for romantic writing',
    preview: {
  ...
  },
  {
    id: 'midnight',
    name: 'Midnight',
    summary: 'Deep dark theme for night owls',
    preview: {
  ...
  },
  {
    id: 'auto',
    name: 'System Auto',
    summary: 'Automatically matches your system preference',
    preview: {
      primary: 'rgb(59 130 246)',
      secondary: 'rgb(244 244 245)',
      background: 'rgb(255 255 255)',
