...
export const generateCharacters = tool({
  ...
  execute: async ({ storyId }) => {
    const response = await fetch('/studio/api/generation/characters', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export const generateSettings = tool({
  ...
  execute: async ({ storyId }) => {
    const response = await fetch('/studio/api/generation/settings', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ storyId }),
    });
...
export const generateParts = tool({
  ...
  execute: async ({ storyId }) => {
    const response = await fetch('/studio/api/generation/parts', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ storyId }),
    });
...
export const generateChapters = tool({
  ...
  execute: async ({ storyId, partId }) => {
    const response = await fetch('/studio/api/generation/chapters', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export const generateSceneSummaries = tool({
  ...
  execute: async ({ storyId, chapterId }) => {
    const response = await fetch('/studio/api/generation/scene-summaries', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export const generateSceneContent = tool({
  ...
  execute: async ({ sceneId }) => {
    const response = await fetch('/studio/api/generation/scene-content', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export const evaluateScene = tool({
  ...
  execute: async ({ sceneId }) => {
    const response = await fetch('/studio/api/generation/scene-evaluation', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ sceneId }),
    });
...
export const generateImages = tool({
  ...
  parameters: z.object({
    ...
    entityId: z.string().optional().describe('Optional: specific entity ID for character/setting/scene'),
  }),
