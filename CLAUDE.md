...
- **Code SSOT**: `apps/web/src/lib/db/schema.ts` is the executable schema (code cannot reference markdown)
- **Generated Output**: `apps/web/drizzle/schema.ts` and `drizzle/relations.ts` are auto-generated by Drizzle Kit
- **Principle**: `src/lib/db/schema.ts` MUST always follow and reflect `novels-specification.md`
- **When updating schema**:
  1. First: Modify specification (`docs/novels/novels-specification.md`)
  2. Second: Update source schema (`src/lib/db/schema.ts`)
