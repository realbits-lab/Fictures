...
describe("Comics System Integration", () => {
	it(
		"should generate comic panels with toonplay conversion",
		async () => {
			// Arrange
	...
	it(
		"should include quality evaluation results",
		async () => {
			// Arrange
			const requestBody: ApiComicsRequest = {
				sceneId: testSceneId,
	...
	it(
		"should generate panels with proper toonplay structure",
		async () => {
			// Arrange
			const requestBody: ApiComicsRequest = {
				sceneId: testSceneId,
	...
	it(
		"should save panels to database",
		async () => {
			// Arrange
			const requestBody: ApiComicsRequest = {
				sceneId: testSceneId,
	...
	it(
		"should track generation timing metadata",
		async () => {
			// Arrange
			const requestBody: ApiComicsRequest = {
				sceneId: testSceneId,
	...
	it(
		"should generate panels with varied shot types",
		async () => {
			// Arrange
			const requestBody: ApiComicsRequest = {
				sceneId: testSceneId,
