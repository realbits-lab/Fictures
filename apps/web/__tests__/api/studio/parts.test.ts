...
describe("Parts API", () => {
    ...
    it("should generate parts via POST /studio/api/parts", async () => {
        ...
        const requestBody: ApiPartsRequest = {
            storyId: testStoryId,
        ...
        const data: ApiPartsResponse | ApiPartsErrorResponse =
            await response.json();
        ...
        if (!("success" in data) || !data.success) {
            throw new Error("Expected ApiPartsResponse but got error");
        }

        // 7. Cast to success response type
        const successData: ApiPartsResponse = data as ApiPartsResponse;
        ...
        // ============================================================================
        const { parts }: { parts: ApiPartsResponse["parts"] } = successData;
        ...
        // 10. Verify metadata
        // ============================================================================
        const { metadata }: { metadata: ApiPartsResponse["metadata"] } =
            successData;
