...
export const cyclePhase = pgEnum("cycle_phase", ['setup', 'adversity', 'virtue', 'consequence', 'transition'])
...
export const apiKeys = pgTable("api_keys", {
	...
	keyHash: text("key_hash").notNull(), // Changed to text() to support bcrypt hashes (60 chars)
