...
export const publishingSchedulesRelations = relations(
	publishingSchedules,
	({ one, many }) => ({
		scheduledPublications: many(scheduledPublications),
		story: one(stories, {
...
export const communityRepliesRelations = relations(
	communityReplies,
	({ one, many }) => ({
...
export const studioAgentToolExecutionsRelations = relations(
	studioAgentToolExecutions,
	({ one }) => ({
