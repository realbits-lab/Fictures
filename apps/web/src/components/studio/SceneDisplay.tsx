...
export function SceneDisplay({
    ...
    // Fetch scene data
    console.log(
        `🔄 [CLIENT] SWR: Initiating scene data fetch from /api/studio/story/${storyId}/scenes/${sceneId}`,
    );
    ...
    console.log(
        `🔄 [CLIENT] SWR: Initiating characters fetch from /api/studio/story/${storyId}/characters`,
    );
    ...
    // Fetch settings data
    console.log(
        `🔄 [CLIENT] SWR: Initiating settings fetch from /api/studio/story/${storyId}/settings`,
    );
