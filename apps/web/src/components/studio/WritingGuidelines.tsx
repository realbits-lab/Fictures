				...
				<div className="space-y-3 text-sm">
					<div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-200 dark:border-blue-700">
						...
						<ol className="list-decimal list-inside space-y-1 text-blue-700 dark:text-blue-300">
							<li>
								<strong>Motivation:</strong> External stimulus/event
							</li>
							<li>
								<strong>Reaction:</strong> Character&apos;s internal response
							</li>
							<li>
								<strong>Action:</strong> Character&apos;s external response
							</li>
						</ol>
					</div>
					<div className="text-xs text-gray-600 dark:text-gray-400">
						<strong>Example:</strong> Door slams (motivation) → John startles
						(reaction) → He reaches for his weapon (action)
					</div>
				</div>
			),
		},
				...
				<div className="space-y-3 text-sm">
					<div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg border border-green-200 dark:border-green-700">
						...
						<ul className="space-y-1 text-green-700 dark:text-green-300">
							...
							<li>
								<strong>Disaster:</strong> Failure or complication
							</li>
							<li>
				...
				<div className="space-y-3 text-sm">
					<div className="bg-yellow-50 dark:bg-yellow-900/20 p-3 rounded-lg border border-yellow-200 dark:border-yellow-700">
						...
						<div className="text-yellow-700 dark:text-yellow-300 space-y-2">
							<div>
								<strong>Fast:</strong> Short sentences, dialogue, action verbs,
								less description
							</div>
							<div>
								<strong>Slow:</strong> Longer sentences, internal thoughts,
								detailed description, reflection
							</div>
						</div>
					</div>
				</div>
					...
					<div className="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg border border-purple-200 dark:border-purple-700">
						...
						<div className="text-purple-700 dark:text-purple-300 space-y-2 text-xs">
							<div>
								...
								<br />
								<strong>Show:</strong> &quot;His jaw tightened as he slammed the
								door&quot;
							</div>
							<div>
								<strong>Instead of:</strong> &quot;She was nervous&quot;
								<br />
								<strong>Show:</strong> &quot;Her fingers drummed against her
								thigh&quot;
							</div>
						</div>
					</div>
