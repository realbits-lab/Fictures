...
export function UnifiedWritingEditor({
    ...
    console.log(
        `📊 [CLIENT] Story has ${initialStory.parts?.length || 0} parts`,
    );
    ...
    const parseStoryData = (): StoryDocument => {
        ...
        if (dataSource) {
            if (typeof dataSource === "object") {
                ...
                try {
                    ...
                    console.error(
                        "Failed to parse story HNS data JSON:",
                        error,
                    );
                }
            }
        ...
        const hnsStory: any = {
            ...
            parts:
                parsedData?.parts?.map((p: any) => `part_${p.part || p.id}`) ||
                [],
        };
            ...
            structural_role:
                index === 0
                    ...
                    : index === 1
                      ...
                      : "Act 3: Resolution",
            summary:
                parsedData?.parts?.[index]?.summary ||
                `Summary for ${part.title}`,
        ...
        story.parts.forEach((part, partIndex) => {
            part.chapters.forEach((chapter, chapterIndex) => {
                hnsChapters.push({
                    ...
                    part_ref: part.id,
                    summary:
                        parsedData?.parts?.[partIndex]?.chapters?.[chapterIndex]
                            ?.summary || "",
                    pacing_goal: "medium",
                    ...
                    chapter_hook: {
                        type: "question",
                        summary:
                            parsedData?.parts?.[partIndex]?.chapters?.[
                                chapterIndex
                            ]?.hook || "",
    ...
    const _handleSave = async (data: any) => {
        ...
        try {
            ...
            if (
                ...
                console.log(
                    "✅ Chapter HNS data saved successfully:",
                    saveResult,
                );
        ...
        if (currentChapter && currentChapterStatus === "published") {
            ...
            const scenesWithContent =
                currentChapter.scenes?.filter(
                    (s) =>
                        (s as any).content && (s as any).content.trim() !== "",
                ) || [];
    ...
    const handleVisibilityToggle = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                const errorData = await response.json();
                throw new Error(
                    errorData.error || "Failed to update story visibility",
                );
            }
            ...
            toast.error(
                "Failed to update story visibility. Please try again.",
                {
                    duration: 5000,
                    position: "top-right",
                    closeButton: true,
    ...
    const _createPartData = (partNum: number, partTitle: string) => {
        ...
        const currentPart = sampleStoryData.parts.find(
            (p: any) =>
                p.part_title === partTitle || p.part_id === `part_${partNum}`,
        );
    ...
    const _findSceneData = () => {
        ...
        const createSceneData = (scene: any, sceneNum: number) => ({
            ...
            characters: {
                ...
                elena: {
                    status: scene?.id?.includes("elena")
                        ? "present"
                        : "referenced",
                },
            },
                                    ...
                                    <table className="w-full text-sm">
                                        <tbody>
                                            ...
                                            <tr className="border-b">
                                                ...
                                                <td className="py-2 px-4 font-mono text-xs">
                                                    {selectedCharacter.visualReferenceId ||
                                                        "N/A"}
                                                </td>
                                            </tr>
                                            <tr className="border-b">
                                            ...
                                            <tr className="border-b">
                                                ...
                                                <td className="py-2 px-4">
                                                    {selectedCharacter.internalFlaw ||
                                                        "N/A"}
                                                </td>
                                            </tr>
                                            <tr className="border-b">
                                                ...
                                                <td className="py-2 px-4">
                                                    {selectedCharacter.externalGoal ||
                                                        "N/A"}
                                                </td>
                                            </tr>
                                            <tr className="border-b">
                                    ...
                                    <table className="w-full text-sm">
                                        <tbody>
                                            ...
                                            <tr className="border-b">
                                                ...
                                                <td className="py-2 px-4">
                                                    {selectedSetting.architecturalStyle ||
                                                        "N/A"}
                                                </td>
                                            </tr>
                                            <tr className="border-b">
                                            ...
                                            <tr className="border-b">
                                                ...
                                                <td className="py-2 px-4">
                                                    {selectedSetting.symbolicMeaning ||
                                                        "N/A"}
                                                </td>
                                            </tr>
                                            <tr className="border-b">
                                            ...
                                            <tr className="border-b">
                                                ...
                                                <td className="py-2 px-4">
                                                    {selectedSetting.emotionalResonance ||
                                                        "N/A"}
                                                </td>
                                            </tr>
                                            <tr className="border-b">
