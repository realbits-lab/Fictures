...
export function SceneSidebar({
    ...
    const [expandedSections, setExpandedSections] = useState<Set<string>>(
        new Set(["foundation", "goal", "beats", "characters"]),
    );
    ...
    return (
        <div className="space-y-4">
                ...
                <div className="space-y-3">
                    ...
                    <div>
                        ...
                        <Input
                            value={sceneData.pov}
                            onChange={(e) =>
                                handleInputChange("pov", e.target.value)
                            }
                ...
                <div className="space-y-3">
                    ...
                    <div>
                        ...
                        <Textarea
                            ...
                            onChange={(e) =>
                                handleInputChange("obstacle", e.target.value)
                            }
                    ...
                    <div>
                        ...
                        <Textarea
                            ...
                            onChange={(e) =>
                                handleInputChange("outcome", e.target.value)
                            }
                    ...
                    {sceneData.beats.map((beat, index) => (
                        <div key={index}>
                            ...
                            <Textarea
                                value={beat}
                                onChange={(e) =>
                                    handleBeatsChange(index, e.target.value)
                                }
            ...
            {renderCollapsibleSection(
                ...
                <div className="space-y-3">
                    <p className="text-xs text-[rgb(var(--color-muted-foreground))] mb-2">
                        Track character states and transformations in this
                        scene.
                    </p>
                    {Object.entries(sceneData.characters).map(
                        ([charName, charData]) => (
                            <div
                                key={charName}
                                className="border border-[rgb(var(--color-border))] rounded-[var(--radius)] p-3"
                            >
                ...
                <div className="space-y-3">
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                handleInputChange("leads_to", e.target.value)
                            }
            ...
            <JSONDataDisplay
                ...
                sceneData={{
                    id:
                        typeof sceneData.id === "string"
                            ? parseInt(sceneData.id, 10)
                            : sceneData.id,
