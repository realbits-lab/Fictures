		...
		<div className="space-y-4">
							...
							<div className="space-y-2">
								<div>
									...
									<Input
										...
										onChange={(e) =>
											handleCharacterChange(charName, "enters", e.target.value)
										}
								...
								<div>
									...
									<Input
										...
										onChange={(e) =>
											handleCharacterChange(charName, "exits", e.target.value)
										}
				...
				<div className="space-y-3">
					<div>
						...
						<Textarea
							...
							onChange={(e) =>
								handleInputChange("image_prompt", e.target.value)
							}
			...
			<Card>
				<CardContent className="pt-4">
					<Button onClick={() => onSave(sceneData)} className="w-full">
						💾 Save Scene Data
					</Button>
				</CardContent>
			</Card>
