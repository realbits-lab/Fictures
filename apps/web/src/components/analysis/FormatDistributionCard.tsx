				...
				{novelViews + comicViews > 0 && (
					<div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
						<p className="text-sm text-gray-700 dark:text-gray-300">
							{stats.formatDistribution.novel >
							stats.formatDistribution.comic ? (
								<>
									📖 <strong>Novel format is more popular</strong> with{" "}
									{stats.formatDistribution.novel}% of readers choosing
									text-based reading.
								</>
							) : stats.formatDistribution.comic >
								stats.formatDistribution.novel ? (
								<>
									🎨 <strong>Comic format is more popular</strong> with{" "}
									{stats.formatDistribution.comic}% of readers preferring visual
									panels.
								</>
							) : (
								<>
									⚖️ <strong>Balanced audience</strong> - readers enjoy both
									novel and comic formats equally.
								</>
							)}
						</p>
					</div>
