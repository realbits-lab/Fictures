                        ...
                        <CardContent className="py-6">
                            <div className="text-center space-y-2">
                                <div className="text-3xl font-bold text-blue-600">
                                    {analysisData?.totalReaders?.toLocaleString() ||
                                        "2.4k"}
                                </div>
                                ...
                                <div className="flex items-center justify-center text-xs text-green-600">
                                    ↗️ +{analysisData?.readerGrowth || 12}% this
                                    week
                                </div>
                            </div>
                        </CardContent>
                    ...
                    <Card>
                        <CardContent className="py-6">
                            <div className="text-center space-y-2">
                                ...
                                <div className="flex items-center justify-center text-xs text-green-600">
                                    ↗️ +{analysisData?.ratingChange || "0.1"}{" "}
                                    this week
                                </div>
                            </div>
                        </CardContent>
                        ...
                        <CardContent className="py-6">
                            <div className="text-center space-y-2">
                                <div className="text-3xl font-bold text-purple-600">
                                    {analysisData?.totalComments?.toLocaleString() ||
                                        "1.2k"}
                                </div>
                                <div className="text-sm text-gray-600 dark:text-gray-400">
                                    Comments
                                ...
                                <div className="flex items-center justify-center text-xs text-green-600">
                                    ↗️ +{analysisData?.commentGrowth || 23}% this
                                    week
                                </div>
                            </div>
                        </CardContent>
                    ...
                    <Card>
                        <CardContent className="py-6">
                            <div className="text-center space-y-2">
                                ...
                                <div className="flex items-center justify-center text-xs text-green-600">
                                    ↗️ +{analysisData?.engagementGrowth || 5}%
                                    this week
                                </div>
                            </div>
                        </CardContent>
                        ...
                        <CardContent className="space-y-4">
                            <div className="space-y-3">
                                ...
                                <div className="text-xs text-gray-500 dark:text-gray-400">
                                    👁️ 3,247 views • 💬 126 comments • ❤️ 456
                                    reactions
                                </div>
                            </div>
                            ...
                            <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                                <div className="space-y-3">
                                    ...
                                    <div className="text-xs text-gray-500 dark:text-gray-400">
                                        👁️ 1,892 views • 💬 67 comments • ❤️ 234
                                        reactions
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                    ...
                                    <div className="flex items-center gap-4 mt-2 text-xs text-gray-500 dark:text-gray-400">
                                        <span>
                                            {readerData?.topPost?.replies ||
                                                347}{" "}
                                            replies
                                        </span>
                                        <span>
                                            {readerData?.topPost?.reactions ||
                                                23}{" "}
                                            reactions
                                        </span>
                                    </div>
                                ...
                                <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                    ...
                                    <div className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                                        {readerData?.recentComment?.likes || 45}{" "}
                                        likes •{" "}
                                        {readerData?.recentComment?.author ||
                                            "@FantasyLover99"}
                                    </div>
                                </div>
                                ...
                                <div className="p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        ...
                                        by{" "}
                                        {readerData?.fanContent?.author ||
                                            "@ArtistPro"}
                                    </p>
                                    <div className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                                        {readerData?.fanContent?.likes || 234}{" "}
                                        likes •{" "}
                                        {readerData?.fanContent?.shares || 12}{" "}
                                        shares
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <span className="font-medium">
                                            {readerData?.demographics?.locations
                                                ?.us || "48"}
                                            %
                                        </span>
                                    </div>
