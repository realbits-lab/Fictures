    ...
    const handleVote = async (voteType: "like" | "dislike") => {
        startTransition(async () => {
            try {
                ...
                switch (entityType) {
                    case "story":
                        endpoint = `/api/studio/story/${entityId}/${voteType}`;
                        break;
                    case "chapter":
                        endpoint = `/api/studio/chapters/${entityId}/${voteType}`;
                        break;
                    case "scene":
                        endpoint = `/api/studio/scenes/${entityId}/${voteType}`;
                        break;
                    case "comment":
                ...
                const newLikeCount =
                    data.likeCount !== undefined ? data.likeCount : likeCount;
                const newDislikeCount =
                    data.dislikeCount !== undefined
                        ? data.dislikeCount
                        : dislikeCount;
