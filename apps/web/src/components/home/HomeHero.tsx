			...
			<div className="container mx-auto px-4 text-center">
				<div className="max-w-4xl mx-auto">
					<h1 className="text-4xl md:text-6xl font-bold text-[rgb(var(--color-foreground))] mb-6">
						...
						<br />
						Welcome to{" "}
						<span className="text-[rgb(var(--color-primary))]">Fictures</span>
					</h1>

					<p className="text-xl md:text-2xl text-[rgb(var(--color-muted-foreground))] mb-8 leading-relaxed">
						Your AI-powered creative writing companion. Craft amazing stories,
						manage your writing projects, and connect with a community of
						passionate writers.
					</p>
