...
export function StoryOverview({ story }: StoryOverviewProps) {
	...
	const progressPercentage =
		story.parts.length > 0 ? (completedParts / story.parts.length) * 100 : 0;
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						...
						<div className="space-y-2">
							<p className="text-sm text-gray-600 dark:text-gray-400">
								🎯 <strong>Current:</strong> Writing Chapter 16 &ldquo;Final
								Confrontation&rdquo;
							</p>
				...
				<Card>
					...
					<CardContent className="space-y-4">
						<div>
							...
							<p className="text-sm text-gray-600 dark:text-gray-400">
								&ldquo;Can Maya master shadow magic to save Elena before power
								corrupts her?&rdquo;
							</p>
						...
						<div className="space-y-2">
							...
							<p className="text-sm">
								<strong>Themes:</strong> Power, Family, Sacrifice
							</p>
						</div>
					</CardContent>
				</Card>
				...
				<Card>
					...
					<CardContent className="space-y-4">
						<p className="text-sm text-gray-700 dark:text-gray-300">
							&ldquo;Analyzing character hierarchy. Maya&rsquo;s arc shows
							positive change potential. Suggest expanding Marcus&rsquo;s mentor
							role in Part III.&rdquo;
						</p>
						<div className="flex gap-2">
