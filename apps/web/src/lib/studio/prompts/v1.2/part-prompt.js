/**
 * Part Generation Prompt v1.2
 *
 * Changes from v1.1:
 * - Added explicit phase keyword requirements for summary field
 * - Updated summary instructions to naturally incorporate cycle terms
 * - Added summary example showing proper keyword integration
 *
 * Root Cause (v1.1 failure):
 * - Part Cycle Coherence metric evaluates SUMMARY text, not characterArcs
 * - Uses keyword detection for 5 phases in summary prose
 * - v1.1 only modified characterArcs structure, which isn't evaluated
 *
 * Target Improvement:
 * - part.cycleCoherence: 2/4 → 4/4 (pass threshold: 3/4)
 * - Keywords required: conflict/struggle, virtue/moral, consequence/result
 *
 * Date: 2025-11-15
 */

export const partPromptV1_2 = {
