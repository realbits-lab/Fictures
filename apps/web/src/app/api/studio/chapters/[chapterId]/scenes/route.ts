...
import { scenes, chapters } from "@/lib/schemas/database";
...
export async function GET(
  ...
  try {
    ...
    console.log(`[ChapterScenes] GET /api/studio/chapters/${chapterId}/scenes - ${chapterScenes.length} scenes in ${duration}ms`);
