...
import { userPreferences } from "@/lib/schemas/database";
        ...
        if (existingPrefs) {
            [updatedPrefs] = await db
                ...
                .set({
                    ...
                    language:
                        body.preferences?.language || existingPrefs.language,
                    timezone:
                        body.preferences?.timezone || existingPrefs.timezone,
                    emailNotifications:
                        body.preferences?.emailNotifications ??
                        existingPrefs.emailNotifications,
                    pushNotifications:
                        body.preferences?.pushNotifications ??
                        existingPrefs.pushNotifications,
                    marketingEmails:
                        body.preferences?.marketingEmails ??
                        existingPrefs.marketingEmails,
                    profileVisibility:
                        body.privacy?.profileVisibility ||
                        existingPrefs.profileVisibility,
                    showEmail:
                        body.privacy?.showEmail ?? existingPrefs.showEmail,
                    showStats:
                        body.privacy?.showStats ?? existingPrefs.showStats,
            ...
            [updatedPrefs] = await db
                ...
                .values({
                    ...
                    emailNotifications:
                        body.preferences?.emailNotifications ?? true,
                    pushNotifications:
                        body.preferences?.pushNotifications ?? false,
                    marketingEmails: body.preferences?.marketingEmails ?? false,
                    profileVisibility:
                        body.privacy?.profileVisibility || "public",
