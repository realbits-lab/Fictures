					...
					<div className="space-y-4">
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-sm text-gray-600 dark:text-gray-400">
									Track comprehensive writing metrics and patterns
								</p>
							</div>
						...
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-sm text-gray-600 dark:text-gray-400">
									Get insights on your writing performance trends
								</p>
							</div>
							<label className="relative inline-flex items-center cursor-pointer">
								<input
				...
				<CardContent className="space-y-6">
					...
					<div className="pt-4 border-t border-gray-200 dark:border-gray-700">
						<p className="text-xs text-gray-500 dark:text-gray-400">
							Analysis data is automatically cleaned up based on your retention
							settings. Stories and user data are kept until you delete them.
						</p>
					</div>
				</CardContent>
			</Card>
