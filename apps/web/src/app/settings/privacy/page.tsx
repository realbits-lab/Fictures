                ...
                <CardContent className="space-y-6">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400">
                                    Allow others to see read counts on your
                                    stories
                                </p>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                    type="checkbox"
                                    defaultChecked={
                                        privacySettings?.showStoryAnalysis !==
                                        false
                                    }
                                    className="sr-only peer"
                                />
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            This will be the default visibility for new stories
                            you create
                        </p>
                    </div>
                ...
                <CardContent className="space-y-6">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400">
                                    Use your data to provide personalized
                                    content
                                </p>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    <div className="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-3">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                            You can request a copy of your data or permanently
                ...
                <CardContent>
                    <div className="text-center py-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-sm">
                            You haven&apos;t blocked any users yet. Blocked
                            users won&apos;t be able to interact with your
                            content.
                        </p>
                    </div>
                </CardContent>
