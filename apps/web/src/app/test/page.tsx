      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            This page is available only in development environment for testing purposes.
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="p-6 border rounded-lg bg-card">
            ...
            <div className="space-y-2 text-sm">
              <p>
                ...
                <code className="px-2 py-1 bg-muted rounded">{process.env.NODE_ENV}</code>
              </p>
              <p className="text-muted-foreground">
                This page is blocked in production by middleware.
              </p>
            </div>
          </div>
          ...
          <div className="p-6 border rounded-lg bg-card">
            ...
            <div className="space-y-2">
              ...
              >
                <div className="font-medium">Cache Performance Test</div>
