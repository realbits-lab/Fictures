	...
	return (
		<div className="container mx-auto p-6 max-w-6xl">
			<div className="bg-white rounded-lg shadow-lg p-8">
				{/* Header */}
				<div className="mb-8">
					<h1 className="text-3xl font-bold mb-2">Cache Performance Test</h1>
					<p className="text-gray-600">
						Tests all three caching layers: SWR Memory (30min) → localStorage
						(1hr) → Redis (10min)
					</p>
				</div>
							...
							{stories.map((story) => (
								...
								>
									...
									<div className="text-sm text-gray-600 mt-2">
										...
										<p>
											Chapters: {story.chaptersCount} | Scenes:{" "}
											{story.scenesCount}
										</p>
								...
								<tbody>
									...
									{testResults.afterUpdate && (
										<tr>
											...
											<td className="border border-gray-300 px-4 py-2">
												{getPerformanceRating(
													testResults.afterUpdate.duration,
													"update",
												)}
											</td>
										</tr>
