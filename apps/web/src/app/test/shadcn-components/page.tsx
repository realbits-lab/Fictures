        ...
        <div className="container mx-auto p-8 space-y-8">
            <div className="space-y-2">
                <h1 className="text-4xl font-bold">
                    Shadcn Component Test Page
                </h1>
                <p className="text-muted-foreground">
                    Testing all installed shadcn/ui components for the Fictures
                    platform
                </p>
            </div>
            ...
            <div className="py-8">
                <Card>
                    ...
                    <CardContent>
                        <p className="text-sm text-muted-foreground">
                            Components tested: Button, Card, Input, Label, Tabs,
                            Badge, Progress, Separator, Avatar, and more.
                        </p>
                    </CardContent>
                </Card>
            </div>
