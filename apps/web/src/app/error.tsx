            ...
            <div className="max-w-2xl w-full text-center">
                ...
                <div className="relative mb-8 inline-block">
                    <div className="relative">
                        ...
                        {/* Decorative Elements */}
                        <div
                            className="absolute -top-2 -right-2 w-6 h-6 bg-[rgb(var(--color-primary))] opacity-50"
                            style={{ borderRadius: "var(--radius-badge)" }}
                        />
                        <div
                            className="absolute -bottom-2 -left-2 w-8 h-8 bg-[rgb(var(--color-primary))] opacity-30"
                            style={{ borderRadius: "var(--radius-badge)" }}
                        />
                    </div>
                </div>
                ...
                <div className="space-y-4 mb-8">
                    ...
                    <p className="text-lg text-[rgb(var(--color-muted-foreground))] max-w-md mx-auto">
                        ...
                        your data is safe. Try refreshing the page or return
                        home.
                    </p>
                ...
                <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
                    <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-[rgb(var(--color-primary))] opacity-5 rounded-full blur-3xl" />
                    <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[rgb(var(--color-destructive))] opacity-5 rounded-full blur-3xl" />
                </div>
            </div>
        </div>
    );
