    ...
    try {
        ...
        const stream = new ReadableStream({
            async start(controller) {
                activeConnections++;
                console.log(
                    `[SSE] Client connected. Active connections: ${activeConnections}`,
                );
                ...
                try {
                    ...
                    console.error(
                        "[SSE] Failed to subscribe to Redis channels:",
                        error,
                    );
                    sendEvent("error", {
                    ...
                    try {
                        ...
                        switch (channel) {
                            case CHANNELS.STORY_PUBLISHED:
                                ...
                                console.log(
                                    "[SSE] Broadcasting story-published event:",
                                    data.storyId,
                                );
                                break;
                            ...
                            case CHANNELS.STORY_UPDATED:
                                ...
                                console.log(
                                    "[SSE] Broadcasting story-updated event:",
                                    data.storyId,
                                );
                                break;
                            ...
                            case CHANNELS.STORY_DELETED:
                                ...
                                console.log(
                                    "[SSE] Broadcasting story-deleted event:",
                                    data.storyId,
                                );
                                break;
                            ...
                            case CHANNELS.POST_CREATED:
                                ...
                                console.log(
                                    "[SSE] Broadcasting post-created event:",
                                    data.postId,
                                );
                                break;
                            ...
                            case CHANNELS.POST_UPDATED:
                                ...
                                console.log(
                                    "[SSE] Broadcasting post-updated event:",
                                    data.postId,
                                );
                                break;
                            ...
                            case CHANNELS.POST_DELETED:
                                ...
                                console.log(
                                    "[SSE] Broadcasting post-deleted event:",
                                    data.postId,
                                );
                                break;
                        ...
                        console.error(
                            "[SSE] Error parsing Redis message:",
                            error,
                        );
                    }
                });
                ...
                request.signal.addEventListener("abort", async () => {
                    ...
                    activeConnections--;
                    console.log(
                        `[SSE] Active connections: ${activeConnections}`,
                    );
