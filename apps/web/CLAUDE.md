...
- Database operations use Drizzle ORM - see `src/lib/db/schema.ts` (single source of truth)
...
- **Source of Truth**: `src/lib/db/schema.ts` - All actual schema definitions live here
- **Generated Output**: `drizzle/schema.ts` and `drizzle/relations.ts` - Auto-generated by Drizzle Kit
- **Config**: `drizzle.config.ts` declares `src/lib/db/schema.ts` as input schema

**Database Schema Usage:**
- **ALWAYS import schema from `src/lib/db/schema.ts` or `@/lib/db/schema`** - This is the single source of truth
...
- **Import Examples**:
  - From source files: `import { users, apiKeys, stories, chapters } from '@/lib/db/schema'`
...
2. **Database Layer**:
   - `src/lib/db/schema.ts` - Drizzle ORM schema definitions (source of truth)
