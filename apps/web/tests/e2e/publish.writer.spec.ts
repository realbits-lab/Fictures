...
test.describe("Publish Page - Writer", () => {
    ...
    test.describe("Navigation Tests", () => {
        test("TC-PUBLISH-NAV-001: Publish menu item highlighted when active", async ({
            page,
        }) => {
    ...
    test.describe("Content Tests", () => {
        test("TC-PUBLISH-CONTENT-001: Publishable stories list displays", async ({
            page,
        }) => {
            const storiesList = page.locator(
                '[data-testid="publishable-stories"]',
            );
    ...
    test.describe("Performance Tests", () => {
        test("TC-PUBLISH-PERF-001: Page loads in under 2 seconds", async ({
            page,
        }) => {
