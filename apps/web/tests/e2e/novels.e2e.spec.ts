...
test.describe("Novels Page", () => {
    ...
    test.describe("Navigation Tests", () => {
        ...
        test("TC-NOVELS-NAV-003: Story card click opens reader", async ({
            page,
        }) => {
    ...
    test.describe("Access Control Tests", () => {
        test("TC-NOVELS-AUTH-001: Anonymous users can access page", async ({
            page,
        }) => {
    ...
    test.describe("Content Tests", () => {
        ...
        test("TC-NOVELS-CONTENT-004: Empty state for no stories", async ({
            page,
            request,
        }) => {
    ...
    test.describe("Performance Tests", () => {
        test("TC-NOVELS-PERF-001: Story grid loads in under 2 seconds", async ({
            page,
        }) => {
    ...
    test.describe("Error Handling Tests", () => {
        test("TC-NOVELS-ERROR-001: Story fetch failure shows error", async ({
            page,
        }) => {
