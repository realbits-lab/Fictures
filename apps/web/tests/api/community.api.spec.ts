...
import { createTestPost, deleteTestPost, generateTestId } from '../helpers/test-data';

test.describe('Community API', () => {
  test.describe('Create Post', () => {
    test('TC-API-COMM-001: Authenticated user can create post', async ({ request }) => {
    ...
    test('TC-API-COMM-002: Anonymous user cannot create post (401)', async ({ request }) => {
  ...
  test.describe('Get Posts', () => {
    test('TC-API-COMM-006: Returns paginated posts', async ({ request }) => {
