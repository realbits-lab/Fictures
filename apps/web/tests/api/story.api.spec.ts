...
import { createTestStory, deleteTestStory, generateTestId } from '../helpers/test-data';

test.describe('Story API', () => {
  test.describe('Create Story', () => {
    test('TC-API-STORY-001: Authenticated writer can create story', async ({ request }) => {
    ...
    test('TC-API-STORY-002: Anonymous user cannot create story (401)', async ({ request }) => {
    ...
    test('TC-API-STORY-004: Missing required fields returns 400', async ({ request }) => {
      const response = await request.post('/studio/api/stories', {
  ...
  test.describe('Get Story', () => {
    test('TC-API-STORY-011: Non-existent story returns 404', async ({ request }) => {
  ...
  test.describe('List Stories', () => {
    test('TC-API-STORY-029: Returns paginated list of stories', async ({ request }) => {
