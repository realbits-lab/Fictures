...
test.describe('Analysis API', () => {
  test.describe('Get Story Analysis', () => {
    test('TC-API-ANALYSIS-002: Non-owner cannot view analysis (403)', async ({ request }) => {
      const response = await request.get('/analysis/api/stories/some-story-id', {
  ...
  test.describe('Record Reading Event', () => {
    test('TC-API-ANALYSIS-013: Event validation works', async ({ request }) => {
