...
import { scheduledPublications, publishingSchedules } from '@/lib/schemas/database';
...
import { db } from '@/lib/db';
import { publishingSchedules, scheduledPublications, scenes, chapters } from '@/lib/schemas/database';
...
import { auth } from '@/lib/auth';
import { db } from '@/lib/db';
import { scheduledPublications, scenes, chapters, stories } from '@/lib/schemas/database';
...
```typescript
import { db } from '@/lib/db';
import { publishingSchedules, scheduledPublications, scenes } from '@/lib/schemas/database';
