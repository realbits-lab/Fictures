...
async function generateTestStory() {
  ...
  try {
    ...
    const storySummary = await fetch(`${BASE_URL}/studio/api/generation/story-summary`, {
      method: 'POST',
    ...
    const characters = await fetch(`${BASE_URL}/studio/api/generation/characters`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
    ...
    const settings = await fetch(`${BASE_URL}/studio/api/generation/settings`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ storySummary }),
    }).then(res => res.json());
    ...
    const parts = await fetch(`${BASE_URL}/studio/api/generation/parts`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
    ...
    const chapters = await fetch(`${BASE_URL}/studio/api/generation/chapters`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
    ...
    const sceneSummaries = await fetch(`${BASE_URL}/studio/api/generation/scene-summaries`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
