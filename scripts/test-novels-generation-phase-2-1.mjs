...
async function testAPI1_StorySummary() {
  ...
  try {
    const response = await fetch(`${BASE_URL}/studio/api/generation/story-summary`, {
      method: 'POST',
...
async function testAPI2_Characters(storySummary) {
  ...
  try {
    const response = await fetch(`${BASE_URL}/studio/api/generation/characters`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function testAPI3_Settings(storySummary) {
  ...
  try {
    const response = await fetch(`${BASE_URL}/studio/api/generation/settings`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ storySummary }),
    });
...
async function testAPI4_Parts(storySummary, characters) {
  ...
  try {
    const response = await fetch(`${BASE_URL}/studio/api/generation/parts`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function testAPI5_Chapters(parts, characters) {
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/studio/api/generation/chapters`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function testAPI6_SceneSummaries(chapter, characters, settings) {
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/studio/api/generation/scene-summaries`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function testAPI7_SceneContent(sceneSummary, characters, settings, chapter, storySummary) {
  ...
  try {
    ...
    const response = await fetch(`${BASE_URL}/studio/api/generation/scene-content`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        sceneSummary,
