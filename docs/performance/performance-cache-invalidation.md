...
import { scenes, chapters, stories } from '@/drizzle/schema';
...
- `docs/performance/performance-caching.md` - General caching strategy (SWR, localStorage, Redis)
- `docs/performance/performance-database.md` - Database optimization
